...
export function EyeLogo({
  ...
  useEffect(() => {
    const onMove = (e: MouseEvent) => {
      ...
      rawX.set((e.clientX - window.innerWidth / 2) / 18);
      rawY.set((e.clientY - window.innerHeight / 2) / 18);
    };
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ═══════════════════════════════════════════════════════════════
            OUTER ARC RING — flat, same plane as the eye (like an iris ring).
            Blue 3/4 arc + Yellow 1/4 arc swing N→E.
        ═══════════════════════════════════════════════════════════════ */}
        <div style={absRing}>
          <motion.svg
            viewBox="0 0 512 512"
        ...
        {/* ═══════════════════════════════════════════════════════════════
            CENTER  —  3-D glowing orb / eye
            radialGradient with off-centre highlight → glass sphere look.
        ═══════════════════════════════════════════════════════════════ */}
        <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center" }}>
          <svg viewBox="0 0 512 512" style={{ width: "100%", height: "100%", overflow: "visible" }}>
            <defs>
              {/* Off-centre radial → 3-D sphere illusion */}
            ...
            {/* Soft ambient glow behind iris */}
            <motion.circle
              cx="256" cy="256" r="90"
              fill={color1} opacity="0.12"
            ...
            {/* Specular highlight — sells the glass sphere */}
            <motion.ellipse
